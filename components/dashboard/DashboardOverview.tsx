...
import { CheckCircle, Clock, SlidersHorizontal, Star, Users } from 'lucide-react';
    ...
    <div className="space-y-8 duration-300 animate-in fade-in">
        ...
        {[
          ...
          <div key={m.label} className="bg-gradient-to-br from-[#1e293b] to-[#334155] border border-[#475569] rounded-xl p-6">
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-[12px] font-semibold text-[#94a3b8] uppercase tracking-wider">{m.label}</h3>
              {m.icon}
            </div>
            <p className="text-3xl font-bold text-[#3b82f6] mb-2">{m.value}</p>
            <p className="text-xs flex items-center gap-1" style={{ color: m.subColor }}>
              <SlidersHorizontal className="h-3 w-3" /> {m.sub}
            </p>
          </div>
        ))}
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-[#1e293b] to-[#334155] border border-[#475569] rounded-xl p-6">
          <h3 className="text-base font-bold text-[#f1f5f9] mb-6 flex items-center gap-2">
            <SlidersHorizontal className="h-4 w-4" /> Completion Trend
          </h3>
        ...
        <div className="bg-gradient-to-br from-[#1e293b] to-[#334155] border border-[#475569] rounded-xl p-6">
          <h3 className="text-base font-bold text-[#f1f5f9] mb-6 flex items-center gap-2">
            <SlidersHorizontal className="h-4 w-4" /> Score Distribution
          </h3>
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
